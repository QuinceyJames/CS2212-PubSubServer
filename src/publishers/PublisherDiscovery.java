...
public class PublisherDiscovery {
	...
	/**
	 * Attribute holding reference to the {@link PublisherPoolManager} to access
	 ...
	 * returns the one instance of {@link PublisherDiscovery} if it exists, and if
	...
	/**
	 * Function to find and return an {@link AbstractPublisher} given an
	 * {@link AbstractPublisher#publisherID ID}
	 * 
